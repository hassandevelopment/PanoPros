...
export default function DevProjectCard({ title, client, description, href }: DevProject) {
    ...
    >
      ...
      >
        ...
        <div className="relative">
          <p className="text-white/50 text-xs font-medium tracking-[0.18em] uppercase mb-1.5">
            {client}
          </p>
