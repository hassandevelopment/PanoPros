...
export default function HomePage() {
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-12 lg:gap-20">

        <Link href="/media" className="cta-link group flex flex-col items-center text-center min-w-0">
          <h2
        ...
        <Link href="/development" className="cta-link group flex flex-col items-center text-center min-w-0">
          <h2
            className="cta-word text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-medium tracking-[-0.02em] leading-none mb-5"
            style={{ fontFamily: "var(--font-playfair), serif" }}
          >
